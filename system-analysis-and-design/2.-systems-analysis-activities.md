...
A class diagram is a diagram consisting of classes and associations among the classes. A **domain model class diagram** is a class diagram that only includes classes from the problem domain. Another is called the design class diagram.
